...
* `Invalid input` gives a map of either empty paths or broken paths for the src file
...
Invalid input {:empty-paths #{[:infra :local :postgres :user] [:infra :local :postgres :password]}, :broken-paths #{}}
----
